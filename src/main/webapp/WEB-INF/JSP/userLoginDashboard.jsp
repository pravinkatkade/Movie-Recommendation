...
<body>
	...
	<div class="container-fluid">
		...
		<!-- Navbar -->
		<nav
			class="container-fluid navbar navbar-expand-lg navbar-dark bg-info fixed-top">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a
						...
						id="actorDropdown" role="button" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"
						style="margin-right: 50px">Actors</a>
						<div class="dropdown-menu dropdown-menu-right"
							aria-labelledby="actorDropdown" style="width: 450px;">
							<div class="container-fluid">
								<div class="row">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="profileDropdown">
							<a class="dropdown-item"
								href="viewProfile?username=${uname}">View Profile</a> 
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<div class="d-flex flex-nowrap overflow-auto"
							...
							<c:forEach var="g" items="${topRatedMovies}" begin="0" end="78">
										...
										<div class="card-body text-center">
											<h5 class="card-title">
												...
												<c:forEach begin="1"
													...
													<i class="fas fa-star"
														style="color: #FFD700; text-shadow: 1px 1px 2px black;"></i>
													<!-- Yellow filled star -->
												</c:forEach>
			...
			<div class="container py-4">
				<div class="row">
					...
					<div class="col-md-3">
						<h5>Genres</h5>
						<ul class="list-unstyled">
							<li><a href="moviesByGenre?genre=${g.gname}"
								class="text-white">Action</a></li>
							<li><a href="moviesByGenre?genre=${g.gname}"
								class="text-white">Drama</a></li>
							<li><a href="moviesByGenre?genre=${g.gname}"
								class="text-white">Comedy</a></li>
							<li><a href="moviesByGenre?genre=${g.gname}"
								class="text-white">Horror</a></li>
						</ul>
					</div>
				</div>
